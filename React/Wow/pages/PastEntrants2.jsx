...
import entrants2 from "../components/images/entrants2.jpg";
      ...
      <div className="row testrow">
        <div className="col-md-6 area5">
          <div className="img_bg">
            <img className="art__img" src={entrants2} alt="wornderofweird" />
          </div>
        </div>
